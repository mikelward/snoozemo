...
| Whether you asked this snooze to end when you move | So the choice survives the app being closed or the phone rebooting, and the snooze still ends the way you asked. It is a yes/no — no movement, step count, or activity of any kind is recorded, and nothing about it leaves the phone | Erased when the snooze ends |
| Whether you asked this snooze to end when you leave | The companion to the row above, for the other exit: choosing a fixed end time takes it off, and *until I leave* puts it back, so the choice has to survive the app being closed or the phone rebooting. It is a yes/no about what you asked for — separate from whether Snoozemo is *able* to watch for a departure, which is the row further down — and nothing about it leaves the phone | Erased when the snooze ends |
| Whether you narrowed this snooze to a fixed end time only | So Snoozemo can tell you the snooze *can still end sooner* when a chosen time left one of the exits above still armed, and only then. It is a yes/no about what you asked for, nothing about it leaves the phone, and *until I leave* or *until I move* clears it again | Erased when the snooze ends |
