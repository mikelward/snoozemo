...
def run_case(name, *, release_exists, asset_state, commits=7, latest_code=0):
    ...
    try:
        ...
        tree = work / "tree"
        bundle = tree / "app/build/outputs/bundle/playRelease"
        bundle.mkdir(parents=True)
        aab = bundle / "app-play-release.aab"
        ...
        env.update(
            ...
            RELEASE_NOTES="• End a snooze when you leave the place",
...
def case_new_release():
    ...
    if creates:
        ...
        check("attaches the bundle", "snoozemo-7.aab" in c, c)
    ...
    check("notes carry the Play text", "End a snooze when you leave" in notes, notes)
...
def case_count_tracks_history():
    ...
    check("asset name follows too", creates and "snoozemo-41.aab" in creates[0], lines)
